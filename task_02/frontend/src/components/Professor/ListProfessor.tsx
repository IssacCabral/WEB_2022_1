...
const ListProfessor = () => {
    ...
    function generateTable(){
        ...
        return professors.map((professor, i) => {
            return <ProfessorTableRow _id={professor._id} name={professor.name} university={professor.university} degree={professor.degree} key={i} deleteProfessorById={deleteProfessorById} />
        })
    }
